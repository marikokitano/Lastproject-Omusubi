              ...
              <div className="lg:grid max-w-70 mx-auto mt-12 md:grid-cols-2 lg:grid-cols-3 lg:gap-10">
                <div className="col-span-2 lg:col-span-2 flex flex-col mb-3 overflow-hidden lg:2/3">
                  <div className="flex-shrink-0">
                    <h1 className="text-base font-bold text-white bg-font-yellow py-1 px-4 mb-5">
                      次回のお届けプラン
                    </h1>
                    <p>2023年6月16日（金）配送予定</p>
                    <p>〇〇様にお届け</p>
                    <img
                      className="object-cover w-full h-55 rounded-lg mt-4"
                      src={item.plan.image}
                      alt=""
                    />
                  </div>
                  ...
                  <div className="flex flex-col justify-between flex-1">
                    <div className="flex-1">
                      ...
                      <div className="block mt-4">
                        <h3 className="text-2xl font-semibold leading-none tracking-tighter text-gray-600 mb-4">
                          {item.plan.name}
                        </h3>
                        <p className="text text-gray-500 leading-6">
                          {item.plan.nextdelivery}
                        </p>
                  ...
                  <div className="col-span-1 lg:col-span-1 flex flex-col mb-12 overflow-hidden lg:w-full">
                    <div className="flex-shrink-0">
                      ...
                      <div>
                        ...
                        <p>〇〇様にお届け</p>
                        <img
                          className="object-cover w-full h-48 rounded-lg mt-4"
                          src={item.plan.image}
                          alt=""
                        />
                      </div>
                      <div className="flex flex-col justify-between flex-1">
                        <div className="flex-1">
                          ...
                          <div className="block mt-4">
                            <h3 className="text-2xl font-semibold leading-none tracking-tighter text-neutral-600 mb-4">
                              {item.plan.name}
                            </h3>
                            <p className="text text-gray-500 leading-6">
                              {item.plan.nextdelivery}
